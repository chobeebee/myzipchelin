...
<body id="sign_body">
    ...
    <main>
        <section id="sign_section">
            ...
            <form action="/member/sign-up" id="sign_up_form" method="post">
                <div class="form_item">
                    <label for="sign_id" class="sign_left_label">아이디</label>
                    <div class="sign_input_box">
                        <input type="text" path="memberId" id="sign_id" class="sign_info_input2" placeholder="영문 소문자/숫자 포함 6~12자"/>
                        <button type="button" id="idAuthBtn" class="auth_button sign_input_button btnBd">중복확인</button>
                    </div>
                </div>
                <div class="form_item">
                    <label for="sign_pwd" class="sign_left_label">비밀번호</label>
                    <div class="inputField sign_info_input">
                        <input type="password" path="memberPwd" id="sign_pwd" class="" placeholder="영문 대소문자/숫자 포함 8~15자"/>
                        <span class="pwdToggle material-symbols-outlined">visibility_off</span>
                    </div>
                    <div class="inputField sign_info_input">
                        <input type="password" path="pwdConfirm" id="sign_pwd2" class="" placeholder="비밀번호 확인"/>
                        <span class="pwdToggle material-symbols-outlined">visibility_off</span>
                    </div>
                </div>
                <div class="form_item">
                    ...
                    <div class="sign_input_box">
                        <input type="text" path="memberName" id="sign_name" class="sign_info_input" placeholder="이름"/>
                    </div>
                </div>
                <div class="form_item">
                    ...
                    <div>
                        <div class="sign_input_box">
                            <input type="email" path="memberEmail" id="sign_email" class="sign_info_input2"
                                        placeholder="이메일"/>
